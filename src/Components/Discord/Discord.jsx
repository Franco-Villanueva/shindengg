const Discord = () => {
    return ( 
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-5xl bg-[#ffffff09] rounded-3xl p-8 space-y-6 md:space-y-0 md:space-x-8">
            ...
            <button className="w-full md:w-auto bg-[#f9b6f9] hover:bg-rose-300 text-white font-semibold py-3 px-6 rounded-full inline-flex items-center justify-center space-x-2 transition duration-300 ease-in-out transform hover:scale-105">
